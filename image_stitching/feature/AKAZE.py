...
class AKAZE(stitch):
    ...
    def stitch(self):
        ...
        # Create akaze object. You can specify params here or later.
        # Here I set Hessian Threshold to 400
        akaze = cv.AKAZE_create()

        # Find keypoints and descriptors directly
        kp1, des1 = akaze.detectAndCompute(self.image1, None)
        end_kp1 = time.time()
        kp2, des2 = akaze.detectAndCompute(self.image2, None)
        end_kp2 = time.time()
...
Total time:\t\t{end_time - start_time}\n")
    ...
    def matchKeypoints(self, kp1, des1, kp2, des2):
        ...
        search_params = None # dict(checks=50)
